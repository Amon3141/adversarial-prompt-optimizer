...
A GAN-like multi-agent system where Attack and Defense prompts compete and improve. This code was used for atmaCup #21, an LLM vulnerability competition challenging participants to create both adversarial prompts that evade filters to generate harmful content and robust defense prompts that block them.
